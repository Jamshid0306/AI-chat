...
export const useBlockStore = defineStore('blocks', {
  state: () => ({
    blocks: [
      { id: 1, img: chatgpt4o, title: 'ChatGPT-4o', description: 'Best for creative writing and coding', klich: "chatgpt", selected: false },
      { id: 2, img: chatgpt4mini, title: 'ChatGPT-4o mini', description: 'Faster responses for quick tasks', klich: "chatgpt", selected: false },
      { id: 3, img: claude, title: 'Claude', description: 'Exceptional at analysis and research', klich: "claude", selected: false },
      { id: 4, img: liama, title: 'Llama 3', description: 'Open source, runs on your device', klich: "liama", selected: false },
